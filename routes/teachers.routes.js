...
import {
    ...
    ExaminationWorkController,

    ReviewerController,

    InnovativeTeachingController,
...
//+++++++++++++++++++++++++++++++++++++
router.get("/research-pb/:T_ID/:username",controller1.getByID);
//+++++++++++++++++++++++++++++++++++
...
// EContent Routes
const controller21 = new EContentController(); 
router.get("/e-content/all", controller21.getAll);
router.get("/e-content/:username", controller21.getByUsername);
router.post("/e-content/create-new", controller21.create);
router.delete("/e-content/remove", controller21.deleteByUsername);
router.put("/e-content/update", controller21.updateByUsername);
router.post("/e-content/filter", controller21.filterData);
// router.post("/e-content/allcols", controller21.getAllColumns); //get names of all columns
// router.post("/e-content/get-filter-cols", controller21.getFilteringColumns) // get names of filtering columns
// router.post("/e-content/get-distinct-vals", controller21.getDistinctValues) // get the distinct values from filtering cols
router.post("/e-content/get-distinct-cols-vals", controller21.getFilteringColumnsWithDistinctValues);  //get distinct values from filter cols
router.post("/e-content/upload-file", upload.array('files'), controller21.uploadFile);
router.get("/e-content/:T_ID/:username",controller21.getByID);

//ExaminationWork Routes
const controller22 = new ExaminationWorkController();
router.get("/exam-work/all", controller22.getAll);
router.get("/exam-work/:username", controller22.getByUsername);
router.post("/exam-work/create-new", controller22.create);
router.delete("/exam-work/remove", controller22.deleteByUsername);
router.put("/exam-work/update", controller22.updateByUsername);
router.post("/exam-work/filter", controller22.filterData);
// router.post("/exam-work/allcols", controller22.getAllColumns); //get names of all columns
// router.post("/exam-work/get-filter-cols", controller22.getFilteringColumns) // get names of filtering columns
// router.post("/exam-work/get-distinct-vals", controller22.getDistinctValues) // get the distinct values from filtering cols
router.post("/exam-work/get-distinct-cols-vals", controller22.getFilteringColumnsWithDistinctValues);  //get distinct values from filter cols
router.post("/exam-work/upload-file", upload.array('files'), controller22.uploadFile);
router.get("/exam-work/:T_ID/:username",controller22.getByID);


// Reviewer Routes
const controller23 = new ReviewerController();
router.get("/reviewer/all", controller23.getAll);
router.get("/reviewer/:username", controller23.getByUsername);
router.post("/reviewer/create-new", controller23.create);
router.delete("/reviewer/remove", controller23.deleteByUsername);
router.put("/reviewer/update", controller23.updateByUsername);
router.post("/reviewer/filter", controller23.filterData);
// router.post("/reviewer/allcols", controller23.getAllColumns); //get names of all columns
// router.post("/reviewer/get-filter-cols", controller23.getFilteringColumns) // get names of filtering columns
// router.post("/reviewer/get-distinct-vals", controller23.getDistinctValues) // get the distinct values from filtering cols
router.post("/reviewer/get-distinct-cols-vals", controller23.getFilteringColumnsWithDistinctValues);  //get distinct values from filter cols
router.post("/reviewer/upload-file", upload.array('files'), controller23.uploadFile);
router.get("/reviewer/:T_ID/:username",controller23.getByID);


// Innovative Teaching Routes
const controller24 = new InnovativeTeachingController();
router.get("/innovative-teaching/all", controller24.getAll);
router.get("/innovative-teaching/:username", controller24.getByUsername);
router.post("/innovative-teaching/create-new", controller24.create);
router.delete("/innovative-teaching/remove", controller24.deleteByUsername);
router.put("/innovative-teaching/update", controller24.updateByUsername);
router.post("/innovative-teaching/filter", controller24.filterData);
// router.post("/innovative-teaching/allcols", controller24.getAllColumns); //get names of all columns
// router.post("/innovative-teaching/get-filter-cols", controller24.getFilteringColumns) // get names of filtering columns
// router.post("/innovative-teaching/get-distinct-vals", controller24.getDistinctValues) // get the distinct values from filtering cols
router.post("/innovative-teaching/get-distinct-cols-vals", controller24.getFilteringColumnsWithDistinctValues);  //get distinct values from filter cols
router.post("/innovative-teaching/upload-file", upload.array('files'), controller24.uploadFile);
router.get("/innovative-teaching/:T_ID/:username",controller24.getByID);
...
router.get("/faculty-pb/:T_ID/:username",controller3.getByID);
...
//+++++++++++++++++++++++++++++++++++++
router.get("/grants/:T_ID/:username",controller4.getByID);
//+++++++++++++++++++++++++++++++++++
...
router.get("/cons-rep/:T_ID/:username", controller5.getByID); // +++++++++++++++++++++++++++++++
...
router.get("/sf-ws/:T_ID/:username",controller8.getByID);
...
router.get("/number-of_mous/:T_ID/:username",controller10.getByID);
...
router.get("/cert-courses/:T_ID/:username",controller11.getByID);
...
router.get("/prof-aff/:T_ID/:username",controller12.getByID);
...
router.get("/facultyresource/:T_ID/:username",controller13.getByID);
...
router.get("/extension-act/:T_ID/:username",controller14.getByID);
...
router.get("/techfest-org/:T_ID/:username",controller15.getByID);
...
router.get("/faculty-achievement/:T_ID/:username",controller16.getByID);
...
router.get("/visit-tours/:T_ID/:username",controller17.getByID);
...
router.get("/contribution-bos/:T_ID/:username",controller18.getByID);
