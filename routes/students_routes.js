...
router.get("/internship-details/:S_ID/:username", controller1.getBySID);
...
router.post("/internship-details/filter", controller1.filterData);
...
router.get("/research-pb/:S_ID/:username", controller2.getBySID);
...
router.get("/conference-pb/:S_ID/:username", controller3.getBySID);
...
router.get("/certificate-courses/:S_ID/:username", controller4.getBySID);
...
router.get("/sports-data/:S_ID/:username", controller5.getBySID);
...
router.get("/event-participation/:S_ID/:username", controller6.getBySID);
...
router.get("/event-org/:S_ID/:username", controller7.getBySID);
...
router.get("/higher-edu/:S_ID/:username", controller8.getBySID);
...
router.get("/tech-events/:S_ID/:username", controller9.getBySID);
