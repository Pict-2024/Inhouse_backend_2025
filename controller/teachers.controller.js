...
// EContent Controller
export class EContentController extends GenericController {
  constructor() {
    super(EContent,'T_ID');
  }
}

//ExaminationWork Controller
export class ExaminationWorkController extends GenericController {
  constructor() {
    super(ExaminationWork,'T_ID');
  }
}


// Reviewer Controller
export class ReviewerController extends GenericController {
  constructor() {
    super(Reviewer,'T_ID');
  }
}

//InnovativeTeaching Controller
export class InnovativeTeachingController extends GenericController {
  constructor() {
    super(InnovativeTeaching,'T_ID');
  }
}
