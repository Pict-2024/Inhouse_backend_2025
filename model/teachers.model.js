...
//EContent Model
export class EContent extends BaseModel {
  constructor() {
    super('e_content', 'T_ID', baseUploadPath)
  }
}


// ExaminationWork Model
export class ExaminationWork extends BaseModel {
  constructor() {
    super('examination_work', 'T_ID', baseUploadPath)
  }
}

// Reviewer Model
export class Reviewer extends BaseModel {
  constructor() {
    super('reviewer', 'T_ID', baseUploadPath)
  }
}


//InnovativeTeaching Model
export class InnovativeTeaching extends BaseModel {
  constructor() {
    super('innovative_teaching', 'T_ID', baseUploadPath)
  }
}
